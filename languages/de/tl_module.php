...
$GLOBALS['TL_LANG']['tl_module']['registration_legend'] = "Registration Settings";

$GLOBALS['TL_LANG']['tl_module']['gtc_page'] = array
(
  'AGB Seite',
  'Bitte wählen Sie die Seite aus, die die AGBs enthält.'
);
...
(
  'Nutzungsvertrag Seite',
  'Bitte wählen Sie die Seite aus, die den Nutzungsvertrag enthält.'
);
